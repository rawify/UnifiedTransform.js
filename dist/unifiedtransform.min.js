/*
UnifiedTransform v0.3.1 10/9/2024
https://github.com/rawify/UnifiedTransform.js

Copyright (c) 2024, Robert Eisele (https://raw.org/)
Licensed under the MIT license.
*/
'use strict';(function(g){function e(){this.matrix=[1,0,0,1,0,0]}const f=2*Math.PI;e.prototype={translate:function(a,c){return this.applyMatrix([1,0,0,1,parseFloat(String(a).replace("px",""))||0,parseFloat(String(c).replace("px",""))||0])},scale:function(a,c=null){null===c&&(c=a);return this.applyMatrix([parseFloat(a)||1,0,0,parseFloat(c)||1,0,0])},rotate:function(a,c,d){"string"==typeof a?-1!==a.indexOf("rad")?(a=a.replace("rad",""),a=parseFloat(a)):(a=a.replace("deg",""),a=parseFloat(a)/360*f):
a=a/360*f;let b=Math.cos(a);a=Math.sin(a);void 0!==c&&this.translate(c,d||0);this.applyMatrix([b,a,-a,b,0,0]);return void 0!==c?this.translate(-c,-(d||0)):this},skewX:function(a){return this.applyMatrix([1,0,Math.tan(parseFloat(a)/360*f),1,0,0])},skewY:function(a){return this.applyMatrix([1,Math.tan(parseFloat(a)/360*f),0,1,0,0])},transform:function(a){for(let c of[...a.matchAll(/(matrix|translate|translateX|translateY|scale|rotate|skewX|skewY)\s*\(([^)]+)\)/g)]){let [,d,b]=c;b=b.trim().split(/[\s,]+/);
...
b.length&&this.skewY(b[0])}}return this},eval:function(a,c){const d=this.matrix;return[a*d[0]+c*d[2]+d[4],a*d[1]+c*d[3]+d[5]]}};"function"===typeof define&&define.amd?define([],function(){return e}):"object"===typeof exports?(Object.defineProperty(e,"__esModule",{value:!0}),e["default"]=e,e.UnifiedTransform=e,module.exports=e):g.UnifiedTransform=e})(this);
